const bestTimeData = [
  {
    ...
    visitpara2:
      'Chennai is one of the cities that has successfully blended the modern, traditional and sides with ease. The city welcomes everyone who wants to seek a soulful and spiritual connection but also those who love shopping for sarees and enjoy good food. There is no conundrum in Chennai when you visit. Its all about the moment, whether you decide to take a stroll down Marina Beach.',
    modalhead: 'Chennai',
...

  {
    ...
    sidepara3:
      'With a temperature that rarely fallsbelow 8 degree Celsius, winter in Kodaikanal (between December and February) is the best time to enjoy various treks, and attend the famous Pongal festival celebrated during January.',
  },
  {
    id: 4,
    heading: '04. Ooty',
    ...
    visitpara2:
      'The poised and elegant Queen of HilStations welcomes you to the kingdom in the clouds. Individuals travel farand wide to partake in the awe-inspiring wonders of one of Indias mostbeloved hill stations — Ootacamund or Ooty. Here, history and culture form asweet medley, while nature sings to its own symphony. Colonial churches,Hindu temples, tribal museums and libraries brand the plains with stories.',
    modalhead: 'Ooty',
    ...
    sidepara3:
      'People who love rainfall and green grassbeds laid over mountains can pack their bags and head straight to Ooty during the monsoon months, which lasts between June and September. Even though you are unlikely to experience the bright, warm sunshine, you will have a great time nevertheless.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    visitparahead: 'What is the best time to visit:',
    visitpara1:
      'October to March is the best time tovisit Madurai. With a hot and dry climate for most of the year, Madurai is bestvisited during the winter season. The town is known for its ancient templesand other architectural and religious masterpieces and receives a generouscrowd of people throughout the year. Madurai is the most fascinating andwelcoming during the months between October and March which coincideswith its winter season.',
    visitpara2:
      'Madurai is one of the oldest culturallyvibrant cities of India. Its historical places and temples have a steady flow oftourists from all around the world.',
    modalhead: 'Madurai',
    img1name: '',
    img2name: '',
    img3name: '',
  ...
  },
  {
    ...
    sidepara1:
      'Tne summer season in Then starts fromthe month of March and continues tl May. The‘months are general hot and not favourable to vistThen. Temperature dung these months rangesbetween 24°C and 42°C.',
    sidepara2:
      'Monsoon in Then! strkes in the month ofJune ang lasts until September. The townexperiences 3 heavy rainfal curing ts time thatils the tonn with zest Despite being at peak of itsbeauty, the town of Theni Is not best to vist during',
    sidepara3:
      'December mars the beginning of winterseason in Theni which ends in the month ofFebruary. The temperature during these monthsvaries fiom 22°C to 32°C, and thus, the townwinesses a pleasant weather and make the sessonbest tovist Then.',
  },
