...
import kanyakumariImg from '../../assets/pictures/Kanyakumari1.jpeg';
            ...
            <Col style={{ margin: '30px' }} lg={3}>
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold">Hogenakkal to Chennai</span>
                    </p>
                  </Card.Title>
                  <Card.Text>
                    <p>
            ...
            <Col style={{ margin: '30px' }} lg={3} className="">
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold">Hogenakkal to Kodaikanal</span>
                    </p>
                  </Card.Title>
                  <Card.Text>
                    <p>
            ...
            <Col style={{ margin: '30px' }} lg={3} className="">
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold"> Hogenakkal to Ooty </span>
                    </p>
                  </Card.Title>
                  <Card.Text>
                    <p>
            ...
            <Col style={{ margin: '30px' }} lg={3} className="">
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold"> Hogenakkal to Madurai</span>
                    </p>
                  </Card.Title>
            ...
            <Col style={{ margin: '30px' }} lg={3} className="">
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold"> Hogenakkal to Theni</span>
                    </p>
                  </Card.Title>
            ...
            <Col style={{ margin: '30px' }} lg={3} className="">
              ...
              >
                ...
                <Card.Body>
                  <Card.Title>
                    <p>
                      <span className=" fw-bold">Hogenakkal to Yercaud </span>
                    </p>
                  </Card.Title>
                  <Card.Text>
                    <p>
